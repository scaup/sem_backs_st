...
From st.lam Require Import lang types typing wkpre generic.lift contexts logrel.definitions logrel.compat_lemmas contexts.
...
Section definition.
  ...
  (* following two lemmas not needed *)
  ...
  (*   induction pC. *)
  (*   - by intros e e' Hee'. *)
  (*   - intros e e' Hee'. simpl. apply (auto_related_ctx_item_typed _ _ _ _ k H). *)
  (*     by apply IHpC. *)
  (* Qed. *)
