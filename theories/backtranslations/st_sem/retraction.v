...
Lemma retraction Γ (e : lam.lang.expr) τ : Γ ⊢ₙₒ e : τ → back_expr (embd_expr e) = e.
Proof.
  intro d.
...
Lemma retraction_ctx_item (Ci : lam.contexts.ctx_item) Γ τ Γ' τ' (dCi : typed_ctx_item Ci Γ τ Γ' τ') : back_ctx_item (embd_ctx_item Ci) = [Ci].
Proof. destruct dCi; simpl; try done; by erewrite !retraction. Qed.

Lemma retraction_ctx (C : lam.contexts.ctx) Γ τ Γ' τ' (dC : typed_ctx C Γ τ Γ' τ') : back_ctx (embd_ctx C) = C.
